...
const testimonials = [
...

  {
    ...
    img: 'Images/traveler2.png',
    name: 'Random Guy',
    job: 'Traverlar',
    rateQuentity: '5/5',
    stars: 'Images/5-stars-icon.png'
  },
]
          ...
          <div className="max-w-[550px] space-y-6 lg:space-y-10">
            ...
            <div className="space-y-6">
              {testimonials.map((testimonial, id) => (
                <div className="max-w-[480px] mx-auto lg:mx-0 bg-fright-deepVioletShade rounded-md md:rounded-[2.5rem] p-4 md:p-6 space-y-6">

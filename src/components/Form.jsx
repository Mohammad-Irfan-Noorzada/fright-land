    ...
    <>
      <section className=" px-4 sm:px-6 md:px-8 lg:px-8 xl:px-12 mt-12 sm:-mt-10">
        <form className="flex flex-col lg:flex-row lg:items-center max-w-[46.875rem] mx-auto lg:max-w-full lg:mx-0 justify-around">
          <div className="relative flex flex-col lg:flex-row gap-6 lg:gap-2 lg:items-center p-6 bg-fright-darkViolet bg-opacity-40 lg:border-[0.5rem] rounded-md
            ...
            <div className="flex flex-col gap-2">
              <label className="text-fright-lightViolet text-[0.935rem]">Location</label>
            ...
            <div className="flex flex-col gap-2">
              <label className="text-fright-lightViolet text-[0.935rem]">Date</label>
              <input 
                type="datetime-local"
            ...
            <div className="flex justify-between lg:justify-start items-center">
              <div className="flex flex-col gap-2">
                <label className="text-fright-lightViolet text-[0.935rem]">People</label>
                <input 
                  type="number" 
              ...
              <div className="flex flex-col ml-2 gap-2">
                <label className="text-fright-lightViolet text-[0.935rem]">Level of scariness</label>
                <div className="flex items-center p-1 xl:p-2 gap-2">
                  <img src="Images/bat-icon.png" alt="bat" className=""/>
                  <img src="Images/pumkin-icon.png" alt="pumkin" className=""/>
                  <img src="Images/ghost-icon.png" alt="ghost" className=""/>
                </div>
              </div>
            </div>

            <div className="relative bg-fright-darkViolet ml-6 xl:ml-16 self-end lg:self-auto">
              <div className="w-36 h-14 xl:w-[11.25rem] lg:w-20 xl:h-24 lg:h-16 bg-gradient-to-r from-fright-lightGradientYellow to-fright-darkGradientYellow 
                ...
                <button className="text-lg xl:text-[27px] font-bold text-fright-white">Search</button>
              </div>
              <img 

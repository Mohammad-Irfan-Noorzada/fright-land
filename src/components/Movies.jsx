        ...
        <div className="relative z-10 mx-auto px-4 sm:px-6 md:px-8 max-w-[50rem] lg:max-w-[75rem]">
          <div className="flex flex-col lg:flex-row gap-6 sm:gap-10 lg:gap-2 bg-fright-darkViolet p-4 lg:p-8 rounded-md md:rounded-[2.5rem]
            ...
            <div className="flex justify-center lg:justify-normal gap-3 md:gap-4">
              <img 
                src="Images/skeleton-cinema.png" 
                alt="ghost" 
                className="max-w-80 w-full h-72 sm:h-96 lg:h-auto rounded-md md:rounded-[2.5rem] object-cover"
              />
              <img 
                src="Images/two-ghosts-cinema.png" 
                alt="volcano" 
                className="max-w-80 w-full h-72 sm:h-96 lg:h-auto rounded-md md:rounded-[2.5rem] object-cover"
              />
            </div>

            <div className="flex items-center justify-center flex-col text-center lg:max-w-[26.25rem] xl:max-w-[29.25rem] w-full p-4 

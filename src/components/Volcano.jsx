...
function Volcano() {
  return (
    <>
      <section className="relative bg-general-bg-pattern bg-cover bg-no-repeat bg-center mt-16 
        ...
        <div className="relative z-10 mx-auto px-4 sm:px-6 md:px-8 max-w-[50rem] lg:max-w-[75rem]">
          <div className="flex flex-col lg:flex-row gap-6 sm:gap-10 lg:gap-2 bg-fright-darkViolet p-4 lg:p-8 rounded-md md:rounded-[2.5rem]
            bg-opacity-80">
            <div className="flex items-center justify-center flex-col text-center lg:max-w-[26.25rem] xl:max-w-[31.25rem] w-full p-4 
              ...
              <p className="opacity-75 text-fright-textColor sm:px-6 lg:px-12">
                Of course, if she manages to leave the volcano first. We have prepared a special labyrinth for her.
              </p>

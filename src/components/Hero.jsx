...
function Hero() {
  return (
    <>
      <section id="home" className="relative bg-hero-bg bg-cover bg-no-repeat bg-center px-4 sm:px-6 md:px-8 py-4 lg:px-12 mt-16 lg:mt-28

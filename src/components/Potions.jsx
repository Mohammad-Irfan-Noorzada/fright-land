...
function Potions() {
  return (
    <>
      <section id="potions" className="mx-auto px-4 sm:px-6 md:px-8 max-w-[60rem] lg:max-w-[85rem] mt-16 lg:mt-28 scroll-m-32">
        <div className="flex flex-col lg:flex-row items-center gap-6 sm:gap-10 lg:gap-5 bg-fright-darkViolet p-4 lg:p-8 rounded-md md:rounded-[2.5rem]
            bg-opacity-80">
          <div className="flex items-center text-center lg:text-left lg:items-start flex-col lg:max-w-[20.25rem] w-full p-4 
              ...
              <div key={id} className="bg-fright-deepVioletShade p-4 flex flex-col items-center lg:items-start xl:flex-row xl:items-center gap-4 md:rounded-[2.5rem] 
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="flex items-center p-2 lg:p-3 rounded-xl lg:rounded-2xl border border-fright-lightGradientPink bg-gradient-to-r 

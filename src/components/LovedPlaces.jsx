...
const places = [
  {
    id: '1',
    img: 'Images/chamber-of-impure.png',
    title: 'Chamber of impure magic',
    visitorsQuantity: '15,784 visitors',
    visitorsImages: 'Images/visitors-1.png',
    reviewsQuanity: '7,892 reviews',
    reviewsStars: 'Images/5-stars-icon.png', 
  },

  {
    id: '2',
    img: 'Images/old-grave.png',
    title: 'old grave',
    visitorsQuantity: '10,231 visitors',
    visitorsImages: 'Images/visitors-2.png',
    reviewsQuanity: '4,123 reviews',
    reviewsStars: 'Images/4-stars-icon.png', 
  },

  {
    id: '3',
    img: 'Images/hangman-hunt.png',
    title: "Dead hangman's hut",
    visitorsQuantity: '6,872 visitors',
    visitorsImages: 'Images/visitors-3.png',
  ...
  {
    id: '4',
    img: 'Images/zombieland.png',
    title: 'Zombieland',
    visitorsQuantity: '17,031 visitors',
    visitorsImages: 'Images/visitors-4.png',
